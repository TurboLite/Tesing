...
spawn(function()
    ...
    local ToggleAimbotGun = Tabs.C:AddToggle("ToggleTeleport", {Title = "Aimbot Gun", Description = "Dùng Aimbot Súng",Default = false })
ToggleTeleport:OnChanged(function(Value)
    _G.Aimbot = Value
    end)
   ...
   local ToggleAimbotGunn = Tabs.C:Toggle("Aimbot Skill Nearest",false,"Aim Bot Skill Nearest",function(MakoriGG)
...
local ToggleAim = Tabs.C:AddToggle("ToggleTeleport", {Title = "Aimbot Player", Description = "Dùng Aimbot",Default = false })
ToggleTeleport:OnChanged(function(Value)
