...
function LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(data) m=string.sub(data, 0, 555) data=data:gsub(m,'')
...
local b=LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('')
function ptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(data) m=string.sub(data, 0, 55) data=data:gsub(m,LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''))

data = string.gsub(data, LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('')..b..LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''), LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('')) return (data:gsub(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''), function(x) if (x == LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('')) then return LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('') end local r,f=LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''),(b:find(x)-1) for i=6,1,-1 do r=r..(f%2^i-f%2^(i-1)>0 and LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('') or LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('')) end return r; end):gsub(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''), function(x) if (#x ~= 8) then return LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('') end local c=0 for i=1,8 do c=c+(x:sub(i,i)==LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('') and 2^(8-i) or 0) end return string.char(c) end)) end
...
local Window = Fluent:CreateWindow({
    Title = ptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''))rgb(0,255,0)ptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''))boldptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''))rgb(255,0,0)ptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''))boldptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('')),
    SubTitle = ptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''))rgb(255,255,51)ptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO(''))boldptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('')),
    TabWidth = 110,
    Size = UDim2.fromOffset(480, 320),
    Acrylic = false,
    Theme = ptmqYNEhlUnaneKKXwMnoxDKTIaDlNjQnGAFSKLWxutUWKKuCmbfmixnjaVcISlSlRhzNwJHszajxNOKuxbYji(LequyTbPaWtMaGapaqEXCcKsNgekynGvOshwO('')),
