...
local Window = Fluent:CreateWindow({
    Title = "<font color='rgb(0,255,0)' weight='bold'>Turbo Lite</font>",
    SubTitle = "<font color='rgb(255,0,0)' weight='bold'>Premium</font> <font color='rgb(255,255,51)' weight='bold'>www.turbolite.asia</font>",
    TabWidth = 110,
